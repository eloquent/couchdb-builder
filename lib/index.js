...
(function() {
  var CommonCoffeeHandler, CommonJsHandler, CouchBuilder, JsonHandler, TextHandler, builder;
  ...
  builder = new CouchBuilder([new CommonCoffeeHandler, new CommonJsHandler, new JsonHandler, new TextHandler]);
